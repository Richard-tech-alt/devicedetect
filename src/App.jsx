...
// // // // // //       <h2 className="text-2xl font-bold text-gray-600 mb-4">User Device Info</h2>
// // // // // //       <button
// // // // // //         onClick={fetchIPInfo}
// // // // // //         disabled={loading}
// // // // // //         className={`px-6 py-3 rounded-full text-white font-semibold shadow-lg transition duration-700 
...
// // // // //         onClick={fetchIPInfo}
// // // // //         disabled={loading}
// // // // //         className={`px-8 py-4 rounded-lg font-bold shadow-lg transition-all duration-700 transform hover:scale-105 border-2
// // // // //           ${loading 
// // // // //             ? "bg-gray-600 border-gray-600 cursor-not-allowed" 
// // // // //             : "bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-600"
// // // // //           }`}
...
// // // // //                 <span className="text-red-600 font-semibold">🌐 IP Address:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.ip}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">🏙️ City:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.city}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">📡 ISP:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.isp}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">📍 Region:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.region}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">🌍 Country:</span>
...
// // // // //             <div className="space-y-3">
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">⏰ Timezone:</span>
...
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">💻 OS:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.os}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">📱 Device:</span>
// // // // //                 <span className="ml-2" style={{ color: '#00ff00' }}>{deviceInfo.deviceType}</span>
// // // // //               </div>
              
// // // // //               <div className="bg-black p-3 rounded-lg border border-gray-600">
// // // // //                 <span className="text-red-600 font-semibold">🖥️ Resolution:</span>
...
// // // // //     <div className="text-blue-600 font-mono space-y-2">
...
// // // // //               {/* Warning Message */}
// // // // //            <div className="text-orange-600 text-base sm:text-lg leading-relaxed text-center sm:text-left mt-8">
...
// // // // //   >
// // // // //     <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-8 sm:py-4 sm:px-12 lg:py-5 lg:px-16 rounded-full text-base sm:text-lg lg:text-xl transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform cursor-pointer">
// // // // //       Submit complaint
// // // // //     </button>
// // // // //   </a>
// // // // //         </div>
...
// // // //                 <div className="text-blue-600 font-mono space-y-2 text-base sm:text-lg text-center sm:text-left mt-8 animate-fade-in">
// // // //                   <div>Initializing connection...</div>
// // // //                   <div>Bypassing firewall...</div>
// // // //                   <div>Accessing secure server...</div>
// // // //                 </div>
...
// // //               {/* Warning Message */}
// // //               {visibleResults.warning && (
// // //                 <div className="text-yellow-500 text-base sm:text-lg leading-relaxed text-center sm:text-left mt-8 animate-fade-in">
// // //                   Your {scanResults.device} was used from another location
// // //                   apart from your home location {scanResults.location.split(',')[0]}, and
// // //                   your data was accessed through your ISP {scanResults.isp.replace(/AS\d+\s+/, '')}.
...
import InternetScanLayout from "./component/InternetScanLayout";
// import DeviceProtection from "./component/DeviceProtetion";
// import WiFiSecurityLayout from "./component/WiFiSecurityLayout";
// import WifiSecurityLayout from "./component/WiFiSecurityLayout";
// import SupportContact from "./component/SupportContact";
// import AccountSecurityScan from "./component/StartScan";
// import SecurityAlertLayout from "./component/SecurityAlert";

function App() {
  return (
    <div>
      <Routes>
        <Route path="/" element={<InternetScanLayout/>} />
